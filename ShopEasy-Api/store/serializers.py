...
class CollectionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Collection
        fields = ["id", "title", "title_ar", "products_count"]
...
class SimpleProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = ["id", "title", "title_ar", "unit_price"]
...
class CreateOrderSerializer(serializers.Serializer):
    ...
    payment_method = serializers.ChoiceField(
        choices=Order.PAYMENT_METHOD, default=Order.PAYMENT_METHOD_COD
    )
    ...
    def save(self, **kwargs):
        with transaction.atomic():
            ...
            customer = Customer.objects.get(user_id=self.context["user_id"])  # type: ignore
